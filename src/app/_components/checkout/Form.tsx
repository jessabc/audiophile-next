...
const schema = yup
  .object({
    ...
    phone: yup
      ...
      .matches(new RegExp("[0-9]{7}"), "Phone number is not valid"),
    ...
    moneyNumber: yup
      ...
      .typeError("Must be a valid format"),
    moneyPin: yup
      .number()
      .required("Required field")
      .typeError("Must be a valid format"),
    paymentDetails: yup
      .string()
      .required("Payment details is a required field"),
  })
  .required();
    ...
    <div className="mx-8 md:mx-12 lg:mx-32">
      ...
      >
        <div className="lg:w-2/3 lg:bg-white lg:p-5">
          <p className="font-bold text-2xl tracking-wider uppercase text-black mb-5">
            checkout
          </p>
          <p className="font-bold text-sm tracking-wider uppercase text-orange my-3">
            billing details
          </p>
          ...
          <div className="md:grid md:grid-cols-2 md:gap-5">
            ...
            <div className="flex flex-col gap-2 mb-5">
              <div className={`flex justify-between items-center`}>
                <label
                  htmlFor="name"
                  className={`font-bold text-sm leading-4 tracking-tighter text-black ${
              ...
              <input
                ...
                {...register("name")}
                className={` font-bold text-sm leading-5 tracking-tight   py-2 pl-4 rounded-lg border border-solid border-black border-opacity-30  focus:outline-orange  caret-orange w-full ${
                  errors.name ? "focus:outline-error " : ""
                }`}
              />
            </div>
          ...
          <div className="md:grid md:grid-cols-2 md:gap-5">
            <div>
              <p className="font-bold text-sm leading-4 tracking-tight text-black mb-3 ">
                Payment method
              </p>
              <p
                className={`font-medium text-sm leading-4 tracking-tight text-error mb-1`}
              >
            ...
            <div className="flex flex-col gap-3 mb-5">
              <div
                className={`flex   items-center rounded-lg border border-solid border-black border-opacity-30  py-2 pl-4  w-full ${
                  isEMoneyRadioSelected
                    ? "border-orange border-2 border-opacity-100"
                    : " "
                }`}
              >
                {/* emoney */}
                ...
                <label
                  htmlFor="eMoney"
                  className={`font-bold text-sm leading-4 tracking-tighter text-black ml-1`}
                >
                  {" "}
                  e-Money
                </label>
          ...
          {isCODInfoVisible && (
            <div className="flex my-5">
              ...
              <p className="font-medium leading-6 text-black opacity-50 w-2/3">
          ...
          <div className="md:grid md:grid-cols-2 md:gap-5">
            ...
            <div className="flex flex-col gap-2 mb-5">
              <div className={`flex justify-between items-center`}>
                ...
                <p
                  className={`font-medium text-sm leading-4 tracking-tight text-error text-right`}
                >
