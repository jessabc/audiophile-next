...
export default function Summary() {
  ...
  const SummaryCartItemElements = cart.map((item) => (
  ...
  const vat = parseInt((0.2 * total).toFixed(0));

  const grandTotal = total + shipping;

  return (
    <div>
      <p className="font-bold text-md leading-6 tracking-wider uppercase text-black mb-3">
        summary
      </p>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
          <div className="flex justify-between">
            <p className="font-medium leading-6 text-black opacity-50 uppercase">
              total
            </p>
        ...
        <div className="flex justify-between">
          ...
          <p className="font-bold text-lg leading-6  uppercase text-orange">
