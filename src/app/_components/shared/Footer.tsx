    ...
    <div className="relative">
      <footer className="bg-dark flex flex-col justify-center items-center px-8 py-20 gap-14 md:px-12 md:items-start lg:px-32">
        ...
        <div className="lg:flex md:justify-between md:w-full">
          ...
          {/* nav */}
          <nav
            className="font-bold text-white text-sm leading-6 tracking-widest uppercase text-center  
                "
          >
        ...
        <p className="font-medium leading-6 text-center text-white opacity-50 md:text-left lg:w-1/2">
        ...
        <div className="flex flex-col justify-center items-center  gap-14 md:flex-row md:justify-between md:w-full">
          <p className="leading-6 text-center text-white opacity-50">
          ...
          <div className="flex gap-5 ">
            <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                fill="#FFF"
                fillRule="nonzero"
                className="hover:fill-orange cursor-pointer"
              />
            </svg>
