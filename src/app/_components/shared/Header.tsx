...
export default function Header() {
  ...
  return (
    <>
      <header
        className="flex justify-between bg-black px-8 py-10 border-b border-gray md:px-12 md:gap-10 lg:px-32 lg:gap-16 sticky top-0 z-10"
        data-aos="fade"
        // data-aos-offset="200"
      ...
      >
          ...
          <ul className="flex flex-col gap-3 md:flex-row">
            ...
            <li className="hover:text-orange">
              <Link
                href="/headphones"
                className={
                  pathname.includes("/headphones") ? "text-orange" : ""
                }
              >
                Headphones
              </Link>
            ...
            <li className="hover:text-orange">
              <Link
                href="/speakers"
                className={pathname.includes("/speaker") ? "text-orange" : ""}
              >
                Speakers
              </Link>
            </li>
            <li className="hover:text-orange">
              <Link
                href="/earphones"
                className={pathname.includes("/earphones") ? "text-orange" : ""}
              >
                Earphones
              </Link>
            </li>
        ...
        <div className=" ">
          <div className="flex relative">
            ...
            <div className="bg-orange rounded-full w-4 h-4  flex justify-center items-center absolute -top-2 -right-2">
