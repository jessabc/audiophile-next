...
export default function HeroProduct() {
    ...
    return (
         <div className=" fade-in relative mb-40 mb:36 md:mb-44 lg:mb-40">
            ...
            <div className="text-white absolute top-0 px-8  flex flex-col items-center justify-center h-full gap-4 md:px-32 md:gap-6 lg:items-start lg:w-1/2 lg:top-1/4">
